        ...
        <div class="col-md-2 col-sm-6 col-xs-6">
            <div class="recommend_box_1">
                <a class="link" href="<?php echo $this->crud_model->product_link($rec['product_id']); ?>">
                    ...
                    <!--<div class="image-box" style="background-image:url('<?php echo $this->crud_model->file_view('product',$rec['product_id'],'','','no','src','multi','one'); ?>');background-size:cover; background-position:center;">-->
                    <!--</div>-->

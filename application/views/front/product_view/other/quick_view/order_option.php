        ...
        <div class="buttons">
            ...
            <?php if($row['enable_size']==1) {
                ...
                foreach ($sizes as $index => $value) {
                    ...
                    ?>
                    <input class="custom-flex" type="radio" name="sizes" <?php echo $checked ?>  value="<?php echo $value ?>" > <span><?php echo $value ?></span>
...
<div class="buttons">
	<div >
	     <ul class="social-nav model-2" style="float: left;margin-top: 10px">
             ...
             <li style="border-top: none;"><a href="#" class="linkedin-social_a" target="_blank" style="background: #01a8e7;"><i class="fa fa-linkedin"></i></a></li>

...
//  $thumbs = $this->crud_model->file_view('product',$row['product_id'],'','','thumb','src','multi','all');
    if($row['product_id']>1043){
     $thumbs  = $this->crud_model->getImage('product_images','multi',$row['product_id'],'image_name','product_id','product');
                ...
                <div class="col-md-2 others-img">
                    ...
                    if($row['product_id']>1043){
                        ...
                        <div class="related-product" id="main<?php echo $i; ?>">
                            <img class="img-responsive img" data-src="<?php echo base_url().'uploads/product_image/'.$row1->image_name; ?>" src="<?php echo base_url().'uploads/product_image/'.$row1->image_name; ?>" alt=""/>
                        </div>
                        <?php
                        $i++;
                    }

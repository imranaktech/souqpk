                ...
                <div class="col-lg-3 col-md-3">
                    ...
                    <div class="information-title" style="margin-bottom: 0px;"><?php echo translate('my_profile');?></div>
                        <ul class="pleft_nav">
                            ...
                            <?php } ?>
                            <a <?php if($this->crud_model->get_settings_value('general_settings', 'product_affiliation_set', 'value') != 'ok') { ?> style="display: none" <?php } ?>
                                    class="pnav_affiliation_point_earnings" href="#"><li><?php echo translate('affiliation_point_earnings');?></li></a>
                            ...
                            <?php if($this->crud_model->get_type_name_by_id('general_settings','83','value') == 'ok'){ ?>
                                <a class="pnav_post_product" href="https://souqpk.com/home/vendor_logup/registration"><li><?php echo translate('post_product');?></li></a>
...
<script>
    ...
    $('.pnav_affiliation_point_earnings').on('click',function(){
        $("#profile_content").html(loading_set);
        $("#profile_content").load("<?php echo base_url()?>home/profile/affiliation_point_earnings");
        $(".pleft_nav").find("li").removeClass("active");
    ...
    $('.pnav_post_product_bulk').on('click',function(){
        $("#profile_content").html(loading_set);
        $("#profile_content").load("<?php echo base_url()?>home/profile/post_product_bulk");
        $(".pleft_nav").find("li").removeClass("active");

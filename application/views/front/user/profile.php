                            ...
                            ?>
                                <span id="inppic" class="set_image">
                                    <label class="" for="imgInp">
                                        <span><i class="fa fa-pencil" style="cursor: pointer;margin-bottom: 11px!important;"></i></span>
                                    </label>
                                    <input type="file" style="display:none;" id="imgInp" name="img" />
                                </span>
                                
                                <span onclick="deleteImage()" id="deleteImage" class="set_image" >
                            <label class="" for="imgdelete">
                                <span><i class="fa fa-trash" style="cursor: pointer;margin-bottom: -45px!important;"></i></span>
                            </label>
...
function deleteImage() {
        $.ajax({
          url: base_url+''+'home'+'/'+'profile'+'/dlt_img',
          data: "new",
          type: 'POST',
          dataType: 'json',
          contentType: false,
          ...
          success: function (data) {
            if(data.code==200){
                var imageurl =base_url+'uploads/user_image/default.jpg';
                $('#blah').css('backgroundImage', "url('"+imageurl+"')");
                $('#blah').css('backgroundSize', "cover");

                alert('Image Deleted Succefully');

        ...
        $('.search_cat').on('click',function(event){
            if(!$(this).hasClass('arrow')){
				...
				if ($(".first_load_check").val() == 'no') {
					...
					$(this).closest('li').find('.cr-icon').removeClass('add');
					$(this).closest('li').find('.cr-icon').addClass('remove');
				}

        ...
        <tr>
            ...
            <td>
                <div class="tag-box tag-box-v3">
                    <h2>Order Detail</h2>  
                    <table>
                    <tr><td><strong>Order NO</strong> : <?php echo $row['sale_code']; ?> </td></tr>       
            ...
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <th style="padding: 5px;background:rgba(128, 128, 128, 0.30)"><?php echo translate('shop name');?></th>
                        <th style="padding: 5px;background:rgba(128, 128, 128, 0.30)"><?php echo translate('shop phone number');?></th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="padding: 5px;text-align:center;background:rgba(128, 128, 128, 0.18)"><?php echo $vender->company; ?></td>
                                <td style="padding: 5px;text-align:center;background:rgba(128, 128, 128, 0.18)"><?php echo $vender->phone; ?></td>

    ...
    <div class="container">
        <div class="page-header">
            <h2 class="section-title section-title-lg">
                <span>
                    <?=translate('premium_packages_for_vendor')?>
                </span>
            </h2>
        </div>
    </div>
                                    ...
                                    <div class="package-body">
                                        ...
                                        <div class="package-details">
                                            <ul class="text-center">
                                                <li>
                                                    <b><?=/*translate('amount_of').*/"<br>".translate('product_upload')?>: </b>
                                                    <?=$key->upload_amount.' '.translate('times');?></li>
                                                
                                                <li><b>Price:</b> Rs. xxx<?/*=currency($key->amount);*/?></li>
                                            </ul>
                                        </div>
                                    </div>
...
<!--                                            <a href="--><?//=base_url()?><!--home/premium_package/purchase/--><?//=$key->package_id;?><!--" class="btn btn-theme btn-theme-sm btn-block">-->
                                            <a class="btn btn-theme btn-theme-sm btn-block">
<!--                                                <span class="active">Get This Package</span>-->
                                                <span class="active">Coming Soon</span>
                                            </a>
                                            <?php } ?>
                                        </div>
                                    </div>

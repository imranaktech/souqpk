                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="logo">
                                <a href="<?php echo $this->crud_model->vendor_link($vendor_id); ?>">
                                    ...
                                    <img class="img-responsive" src="<?php echo base_url();?>uploads/vendor_logo_image/<?php echo $result[0]->logo ?>"  style="height:90px; width:90px" alt="Shop"/>
                                    <?php }else{?>
                        ...
                        <div class="col-md-7 col-sm-12 col-xs-12">
                            ...
                            <?php if(!empty($result[0]->banner)) {?>
                                <img src="<?php echo base_url();?>uploads/vendor_banner_image/<?php echo $result[0]->banner ?>" width="650" height="250">

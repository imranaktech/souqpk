...
<div class="thumbnail box-style-1 no-padding" itemscope itemtype="http://schema.org/Product">
    <div class="media">
        ...
        <?php if ($product_id>1043){
         ?>
        data-src="<?php 
        echo $this->crud_model->getImage('product_images','single',$product_id,'image_name','product_id','product'); ?>"
    <?php } else { ?>

        data-src="<?php echo $this->crud_model->file_view('product',$product_id,'','','no','src','multi','one'); ?>"
    <?php } ?>

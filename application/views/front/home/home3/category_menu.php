<!-- PAGE -->
<section class="page-section category_menu" style="padding-bottom: 10px;padding-top:0px;">
    <div class="entry-content">
        <div class="row main-slider-row flex-no-gutters">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="main-slider">
                    <div class="owl-carousel" id="main-slider" style="overflow: hidden;">
                        <?php
                        ...
                        <div class="item slide<?php echo $i; ?> alt">
                            <img class="slide-img image_delay" src="" data-src="<?php echo $this->crud_model->file_view('slides',$row['slides_id'],'100','','no','src','','','.jpg') ?>" alt="" />
                            <div class="caption">
                                <div class="div-table">
                                    <div class="div-cell">

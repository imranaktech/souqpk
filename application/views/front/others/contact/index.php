<!-- Messenger Chat Plugin Code -->
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "103502024712407");
                    ...
                    <div class="media-list">
						<div class="media">
							...
							<div class="media-body">
								...
								<a href="https://www.souqpk.com" style="color: #00b16a;font-weight: bold;">www.souqpk.com</a>
							</div>
						</div>
						<div class="media">
							<i class="pull-left fa fa-envelope-o"></i>
							<div class="media-body">
								<strong><?php echo translate('email');?>: For Information</strong><br>
								<a href="mailto:info@souqpk.com" style="color: #00b16a;font-weight: bold;">
									info@souqpk.com
								</a>
							</div>
						</div>
						<div class="media">
							<i class="pull-left fa fa-envelope-o"></i>
							<div class="media-body">
								<strong><?php echo translate('email');?>: For Support</strong><br>
								<a href="mailto:support@souqpk.com" style="color: #00b16a;font-weight: bold;">
									support@souqpk.com
								</a>
							</div>
						</div>

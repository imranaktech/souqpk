...
<!--=== Breadcrumbs ===-->
<h3 >Dear <?php echo $venderName?></h3>
<p style="margin-top: -33px;" >Please check your order at souqpk account.</p>

<p style="margin-top: -33px;" >Its been 24 hours you haven’t responded to your order.
Please respond at earliest otherwise your account will be blocked..</p>
<!--=== End Breadcrumbs ===-->

<!--=== Content Part ===-->
<table  width="100%" style="background:rgba(212, 224, 212, 0.17);margin-top: -50px">
    <?php
            ...
            <td style="text-align:right;">
               <table width="100%">
                ...
                <tr>
                    ...
                    <td style="text-align:right;padding:3px"><h2><?php echo currency($saleData['grand_total']);?></h2></td>
                </tr>
            </table>

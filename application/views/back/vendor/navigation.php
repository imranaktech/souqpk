            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <?php
                                            ...
                                            <li <?php if($page_name == "product_bulk_upload"){?> class="active-link" <?php } ?> >
                                                <a href="<?php echo base_url(); ?>vendor/product_bulk_upload">
                                                    <i class="fa fa-circle fs_i"></i>
                                                    <?php echo translate('Product_bulk_upload');?>
                                                </a>
                                            </li>
                                        <?php
                        ...
                        <li <?php if($page_name=="paid_services_list"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>vendor/paid_services/add_service">
                                <i class="fa fa-lock"></i>
                                <span class="menu-title">
                                    <?php echo translate('paid_services');?>
                                </span>
                            </a>
                        </li>

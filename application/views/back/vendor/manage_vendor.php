    ...
    <div class="tab-base">
        <div class="panel">
            <div class="panel-body">
                ...
                <input type="hidden" name="preImage" value="<?php echo $row['profile_imge'] ?>">
                <div class="profile-pic" style="text-align: center;cursor: pointer;">
                        <?php if(!empty($row['profile_imge'])){?>
                        <img alt="User Pic" src="<?php echo base_url('vender/'. $row['profile_imge']);?>" id="profile-image1" height="200">
                    <?php }else{?>
                           <img alt="User Pic" src="https://d30y9cdsu7xlg0.cloudfront.net/png/138926-200.png" id="profile-image1" height="200">
                    <?php } ?>                        
                    <input id="profile-image-upload" class="hidden" type="file"
                         onchange="loadFile(event)" name="profile_image" >

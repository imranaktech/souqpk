        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">
                <div class="tab-base">
                        ...
                        <div class="form-group btm_border" style="display:none">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="today_deal">
                                    <option value="no"
                                    <?php echo ($row['deal'] == 'no') ? 'selected' : '' ?>>no</option>
                                    <option value="ok"<?php echo ($row['deal'] == 'ok') ? 'selected' : '' ?>>ok</option>
                                </select>
                            </div>
                        </div>  
                        ...
                        <div class="form-group btm_border" style="display:none">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="featured">
                                    ...
                                    <option value="ok" <?php echo ($row['featured'] == 'ok') ? 'selected' : '' ?>>ok</option>
                                </select>
                            </div>
                        </div> 
                        <div class="form-group btm_border">
                    ...
                    <div class="col-sm-6">
                        <div id="choose_file">
                        <label for="demo-hor-inputpass" class="pull-left btn btn-default btn-file"><?php echo translate('choose_file');?></label>
                        <input type="file" multiple name="images[]"  id="demo-hor-inputpass" accept="image/png, image/bmp, image/jpeg" class="form-control " style="display:none;">
                        </div>

                        <div id="add_more">
                        <label for="demo-hor-inputpass" class="pull-left btn btn-default btn-file"><i class="fa fa-plus"></i></label>
                        <input type="file" multiple name="images[]"  id="demo-hor-inputpass" accept="image/png, image/bmp, image/jpeg" class="form-control " style="visibility:hidden;" >
                        </div>
                        ...
                        <div class="form-group btm_border">
                            ...
                            <div class="col-sm-6">
                               ...
                               if($row['product_id']>1043){
                                ...
                                $images  = $this->crud_model->getImage('product_images','multi',$row['product_id'],'image_name','product_id','product');
                                if($images){
                                    foreach ($images as $row1){
                                        ...
                                        <div class="delete-div-wrap">
                                            ...
                                            <div class="inner-div">
                                                <img class="img-responsive" width="100" src="<?php echo base_url().'uploads/product_image/'.$row1->image_name; ?>" 
                                                data-id="<?php echo $row1->image_name; ?>" alt="User_Image" >
                                            </div>
                                        </div>
                                        <?php 
                                    }
...
<script type="text/javascript">
    ...
    var images_names = [];
    var content = <?php echo json_encode($images); ?>;
    var imagesLength = content.length;

    $('#demo-hor-inputpass').change(function () {
    ...
    function upload(img) {
        let TotalImages = $('#demo-hor-inputpass')[0].files.length;
        var length =images_names.length+TotalImages;
        let image_upload = new FormData();

        let images = $('#demo-hor-inputpass')[0];

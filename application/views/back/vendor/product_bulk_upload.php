    ...
    <div class="tab-base">
        <div class="panel">
            <div class="panel-body">
                ...
                <img src="<?php echo base_url('uploads/'. 'loading-buffering.gif');?>" class="loader" />
                                        ...
                                        <div class="details-wrap">
                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div id="product_sub_category" class="modal fade bd-example" tabindex="-1"
                                                    role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog ">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <span class="btn btn-default btn-file">
                                                ...
                                                <input type="file" class="form-control" name="bulk_file" id="bulk_file" accept=".xls,.xlsx">
                                            </span>
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-mint btn-labeled fa fa-upload" id="upload_file" type="submit"><?php echo translate("Upload Products") ?></button>
                                        </div>

                                            <div class="alert alert-success alert-dismissible" role="alert">
                                                Products uploaded <span id="file_name"></span>
...
<script type="text/javascript">
    ...
    function upload(img) {
        ...
        var inputFile=$('input[name=bulk_file]');
        var fileToUpload=inputFile[0].files[0];

        if(fileToUpload.size > 15000000) {
               alert('Please upload file less than 15MB.');
               $("#bulk_file").val('');
               return false;
           }
       ...
       image_upload.append('bulk_file', fileToUpload);
      $.ajax({
          url: base_url+''+user_type+'/product_bulk_upload_save/',
          data: image_upload,
          type: 'POST',
          dataType: 'json',
          contentType: false,

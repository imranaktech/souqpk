        ...
        foreach($sale as $row){
            ...
            <div class="col-md-8 bordered print">
                <div class="tab-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <div class="panel panel-bordered-grey shadow-none">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Order_NO');?></b></td>
                                                    <td><i><?php echo translate($row['sale_code']); ?></i></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><b><?php echo translate('order_date');?></b></td>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo translate('shop name');?></th>
                                                <th><?php echo translate('shop phone number');?></th>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="panel panel-colorful panel-grey shadow-none">
                                            <div class="panel-heading">
                                                <h1 class="panel-title"><?php echo translate('Billing_and_shipping_detail');?></h1>
                                            </div>
                                            <!--List group-->
                                            <table class="table" border="0">
                                                <tbody>
                    ...
                    <h4>Note</h4>
                    <b style="color:red">Delivery is subjected to availability of Product with Vendor. For further delivery  </b>
                    <br ><b style="color:red">details kindly contact the vendor </b>

                    <!--<div class="panel-body" id="demo_s">-->
                        <!--    <div class="panel panel-bordered panel-dark shadow-none">-->
                            <!--        <div class="panel-heading">-->
                                <!--            <h1 class="panel-title"><?php echo translate('Note');?></h1>-->
                                <!--        </div>-->
                                <!--        <div class="table-responsive">-->
                                    <!--            <div class="col-lg-6 col-md-6 col-sm-6 pull-right margin-top-20">-->
                                        <!--                <div class="panel panel-colorful panel-grey shadow-none">-->
                                            <!--                    <table class="table" border="0">-->
                                                <!--                        <tbody>-->
                                                    <!--                            <tr>-->
                                                        <!--                                <td><b>Delivery is subjected to availability of Product with Vendor.For further delivery details </b></td>-->
                                                        <!--                            </tr>-->
                                                        <!--                            <tr>-->
                                                            <!--                                <td><b>Detail:Kindly Contact the Vendor </b></td>-->
                                                            <!--                            </tr>-->
                                                            <!--                        </tbody>-->
                                                            <!--                    </table>-->
                                                            <!--                </div> -->
